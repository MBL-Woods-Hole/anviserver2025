...
from main.views import projects, pangenomes, index, interactive, teams, profile, redirect, settings
...
urlpatterns = [
    ...
    path('pangenome/<project_slug>', interactive.show_interactive, name="show_interactive"),
    #path(')
...
handler400 = index.handler400
handler403 = index.handler403
handler404 = index.handler404
handler500 = index.handler500
